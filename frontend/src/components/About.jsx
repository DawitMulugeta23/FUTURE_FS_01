...
const About = () => {
  ...
  return (
    <section
      id="about"
      className={`py-8 px-6 transition-all duration-500 ${isDark ? "bg-slate-900 text-white" : "bg-white text-slate-900"}`}
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            ...
            ></div>
            <div
              className={`relative p-6 rounded-[3rem] border-2 border-dashed ${isDark ? "border-slate-700 bg-slate-800/50" : "border-blue-100 bg-blue-50/30"}`}
            >
              <h3 className="text-7xl font-black opacity-10 absolute top-0 left-5 italic">
                ABOUT
              </h3>
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="#contact"
                className={`px-6 py-2 rounded-xl font-bold border-2 transition-all ${isDark ? "border-slate-700 hover:bg-slate-800" : "border-blue-100 hover:bg-blue-50"}`}
              >
                Get in Touch
              </a>
            </div>
