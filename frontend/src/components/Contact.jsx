      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:dawitmulugetas23@gmail.com" className="font-medium hover:text-blue-600 transition">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">+251 709700335 / +251 968871794</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {contacts.map((item) => (
            ...
            >
              <div className={`relative w-20 h-20 mb-4 rounded-full flex items-center justify-center p-1 transition-all duration-500 bg-transparent ${item.glow} group-hover:shadow-2xl`}>
                <img 
                  src={item.icon} 
                  alt={item.name} 
              ...
              <span className={`text-xs font-black uppercase tracking-[0.2em] transition-colors duration-300 ${
        ...
        {/* Phone Numbers */}
        <div className={`mt-12 p-8 rounded-[4rem] text-center border-2 border-dashed transition-all duration-500 ${
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            <div className="group cursor-pointer">
              ...
              <p className="text-2xl font-black text-blue-600 group-hover:scale-110 transition-transform">0709700335</p>
            </div>
            <div className="group cursor-pointer">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Ethio Telecom</p>
              <p className="text-2xl font-black text-blue-600 group-hover:scale-110 transition-transform">0968871794</p>
            </div>
          </div>
        </div>
      </div>
