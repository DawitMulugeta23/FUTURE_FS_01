...
const Skills = () => {
  ...
  const allSkills = [
    ...
    { name: "JavaScript", category: "Language", level: "Advanced", percentage: 85, icon: "🟡" },
    { name: "Python", category: "Language", level: "Intermediate", percentage: 75, icon: "🐍" },
    { name: "PHP", category: "Language", level: "Intermediate", percentage: 70, icon: "🐘" },
    { name: "Java", category: "Language", level: "Intermediate", percentage: 65, icon: "☕" },
    { name: "HTML/CSS", category: "Language", level: "Advanced", percentage: 90, icon: "🎨" },
    
    // Frameworks & Libraries
    { name: "React.js", category: "Framework", level: "Advanced", percentage: 85, icon: "⚛️" },
    { name: "Node.js", category: "Framework", level: "Intermediate", percentage: 75, icon: "🟢" },
    { name: "Express.js", category: "Framework", level: "Intermediate", percentage: 70, icon: "🚂" },
    { name: "Tailwind CSS", category: "Framework", level: "Advanced", percentage: 85, icon: "🎨" },
    { name: "Bootstrap", category: "Framework", level: "Intermediate", percentage: 75, icon: "🅱️" },
    
    // Databases
    { name: "MongoDB", category: "Database", level: "Intermediate", percentage: 75, icon: "🍃" },
    { name: "MySQL", category: "Database", level: "Intermediate", percentage: 70, icon: "🐬" },
    { name: "PostgreSQL", category: "Database", level: "Beginner", percentage: 50, icon: "🐘" },
  ];

  // Group skills by category
  const groupedSkills = {
    "Programming Languages": allSkills.filter(skill => skill.category === "Language"),
    "Frameworks & Libraries": allSkills.filter(skill => skill.category === "Framework"),
  ...
  if (loading) {
    return (
      <section id="skills" className={`pt-8 pb-12 px-6 ${isDark ? "bg-slate-900" : "bg-gray-50"}`}>
          ...
          {Object.entries(groupedSkills).map(([category, skills]) => (
            skills.length > 0 && (
              <div key={category} className="mb-10">
                <h3 className={`text-2xl font-bold text-center mb-6 flex items-center justify-center gap-3 ${getCategoryColor(category)}`}>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-base font-bold text-blue-600">{skill.percentage}%</span>
                        </div>
                      </div>
                ...
                >
                  <div>
                    <div className="w-full aspect-square mb-2 rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center">
                      {cert.img && cert.img !== '#' && !cert.img.includes('via.placeholder.com') ? (
                        <img
                          src={cert.img}
                          alt={cert.title}
